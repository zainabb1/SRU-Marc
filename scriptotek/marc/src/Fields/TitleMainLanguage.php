...
class TitleMainLanguage extends Field implements FieldInterface
{
    //loc uses 245 record as main title record 
    //in case the book is not english they save the transliteration of the title in 245
    // the title in the main language is saved in the field 880
    public static function get(Record $record)
    {

        return parent::makeFieldObject($record, '880');
    }
